...
Some people were telling the truth.
...
Then there was one game that made me question that.

## Chapter 1｜A Story That Seemed to Close

In that game, I was a wolf.

I had been claiming to be the Guard.
...
The real Seer and the real Guard were both wolves.

That day, the real Seer checked me and called me wolf.

If anything, that made my story feel more complete.

That night, we did not target the power role.

We targeted the villager.
...
There was one part of the story.
...
I really was the Guard.

Then.

The Seer who checked me and called me wolf was a wolf.

The player counterclaiming Guard was also a wolf.
...
They targeted the villager instead.
...
If the counterclaim was the real Guard.
...
Maybe what I had been comparing was not identity itself.

But:

**which world could explain everything that had already happened.**
...
Why didn’t the wolves target me?
...
I protected myself last night, so no one died.

That explains what happened last night.

But the Guard cannot self-protect two nights in a row.

Even if town votes out one “wolf” during the day.

The remaining wolf can still kill me at night.
...
But laying out all possible worlds.
...
I thought my reasoning just was not good enough.
...
Only the one true world would remain.

Later, I realized.

The problem was not that I was not good enough at reasoning.

It was that the goal I had been chasing — **reaching the one true world through reasoning** — might not exist in the first place.
...
Both could explain the game.

Neither had an obvious hole.

Neither could be falsified.

They could stay alive at the same time.

All the way until the game ended.

I slowly realized.

Truth is not something we can force into view by reasoning harder.

It is only revealed at the end.

Before the game ends.

All we can see are claims, votes, kill targets, checks, and the actions each player leaves behind.

Those pieces of information can rule out some worlds.
...
That only one world will remain.

## Chapter 5｜Truth Is Not the End

At first.

I thought that if I exposed the lie, I would get the truth.
...
Is not prove which world is true.
...
But perhaps what the world really asks of us is not to find the truth.

It asks us.

To make a choice while the full truth is still hidden.

In Werewolf.

That choice is the vote.
